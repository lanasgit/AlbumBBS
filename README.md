...
<p>JSP Model1 방식을 공부하면서 만들어 보았습니다.</p>
<p>(JSP 페이지에서 출력과 로직을 모두 처리하는 방식)</p>
</blockquote>
...
<div>2.텍스트 에디터 추가</div>

![텍스트에디터 추가](https://user-images.githubusercontent.com/66877863/90771011-a33def00-e32d-11ea-8e2c-aca6bf6798c8.PNG)
